...
"This subsystem is turned off by default for backward compatiblity, but if you fit the "larger enterprise deployment" description above, then we highly recommend you turn this mode on. "
...
Secuirty Exceptions Jenkins throws for this feature:
